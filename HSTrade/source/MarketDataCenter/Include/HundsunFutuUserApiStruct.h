#if !defined(HUNDSUNFUTUUSERAPISTRUCT_H)
#define HUNDSUNFUTUUSERAPISTRUCT_H
...
//错误信息
struct CHundsunFutuRspInfoField
{
    int       ErrorNo;                  //错误代码
...
//用户信息
struct CHundsunFutuUserInfoField
{
...
//339204 历史转账流水查询请求
struct CHundsunFutuReqFuncSvrbankHisBktransferQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
    char      BankNo[4];                //银行代码
...
//339204 历史转账流水查询应答
struct CHundsunFutuRspFuncSvrbankHisBktransferQryField
{
    int       BranchNo;                 //分支机构
    int       InitDate;                 //交易日期
    int       CurrDate;                 //当前日期
...
//331153 客户委托方式查询请求
struct CHundsunFutuReqFuncClientEntrustwayQryField
{
};

//331153 客户委托方式查询应答
struct CHundsunFutuRspFuncClientEntrustwayQryField
{
    int       BranchNo;                 //分支机构
...
//332296 银行账户查询请求
struct CHundsunFutuReqFuncBankaccQryField
{
};

//332296 银行账户查询应答
struct CHundsunFutuRspFuncBankaccQryField
{
    char      MoneyType[3];             //币种类别
    char      BankNo[4];                //银行代码
    char      BankName[64];             //银行名称
...
//332200 银行转账请求
struct CHundsunFutuReqFuncBankTransferField
{
    char      MoneyType[3];             //币种类别
    char      BankNo[4];                //银行代码
...
//332200 银行转账应答
struct CHundsunFutuRspFuncBankTransferField
{
    int       EntrustNo;                //委托编号
};

//332250 存管资金账户转账日志查询请求
struct CHundsunFutuReqFuncBanktransferQryField
{
    char      BankNo[4];                //银行代码
    int       EntrustNo;                //委托编号
    int       ActionIn;                 //操作控制值
...
struct CHundsunFutuRspFuncBanktransferQryField
{
    int       BranchNo;                 //分支机构
    char      FundAccount[18];          //资产账户
    char      BankNo[4];                //银行代码
...
//332253 银行余额查询请求
struct CHundsunFutuReqFuncFundamtQryField
{
    char      FundPassword[15];         //资金密码
    char      BankPassword[15];         //银行密码
    char      BankNo[4];                //银行代码
...
//332253 银行余额查询应答
struct CHundsunFutuRspFuncFundamtQryField
{
    int       SerialNo;                 //流水序号
};

//332297 银行转账请求
struct CHundsunFutuReqFuncUfxbankTransferField
{
    char      BankNo[4];                //银行代码
    char      MoneyType[3];             //币种类别
    char      TransferDirection;        //交易方向
...
//332297 银行转账应答
struct CHundsunFutuRspFuncUfxbankTransferField
{
    int       ErrorNo;                  //错误代码
...
//332298 银行余额查询请求
struct CHundsunFutuReqFuncUfxbankBkbalanceQryField
{
    char      MoneyType[3];             //币种类别
    char      BankNo[4];                //银行代码
    char      FundPassword[15];         //资金密码
...
//332298 银行余额查询应答
struct CHundsunFutuRspFuncUfxbankBkbalanceQryField
{
    double    OccurBalance;             //发生金额
};

//331157 客户银行账户查询请求
struct CHundsunFutuReqFuncClientBankacctQryField
{
    char      MoneyType[3];             //币种类别
    char      BankNo[4];                //银行代码
};
...
//331157 客户银行账户查询应答
struct CHundsunFutuRspFuncClientBankacctQryField
{
    int       OpenDate;                 //开户日期
    char      FundAccount[18];          //资产账户
    char      MoneyType[3];             //币种类别
...
//332254 客户资金快速查询请求
struct CHundsunFutuReqFuncClientFundFastQryField
{
    char      MoneyType[3];             //币种类别
};

//332254 客户资金快速查询应答
struct CHundsunFutuRspFuncClientFundFastQryField
{
    char      MoneyType[3];             //币种类别
...
//331150 客户信息查询请求
struct CHundsunFutuReqFuncClientAllQryField
{
    char      QueryMode;                //查询模式
};

//331150 客户信息查询应答
struct CHundsunFutuRspFuncClientAllQryField
{
    int       BranchNo;                 //分支机构
...
//331100 客户登录请求
struct CHundsunFutuReqFuncClientLoginField
{
    int       OpBranchNo;               //操作分支机构
    char      OpEntrustWay;             //委托方式
    char      OpStation[255];           //站点地址
...
//331100 客户登录应答
struct CHundsunFutuRspFuncClientLoginField
{
    int       InitDate;                 //交易日期
    char      SysStatus;                //系统状态
...
//331101 客户密码更改请求
struct CHundsunFutuReqFuncClientPwdModField
{
    char      NewPassword[50];          //新密码
};

//331101 客户密码更改应答
struct CHundsunFutuRspFuncClientPwdModField
{
    int       ErrorNo;                  //错误代码
    char      ErrorInfo[20];            //错误提示
};
...
//338218 期权询价请求
struct CHundsunFutuReqFuncForquoteinsertField
{
...
//338218 期权询价应答
struct CHundsunFutuRspFuncForquoteinsertField
{
    int       EntrustNo;                //委托编号
    char      ForquoteReference[32];    //询价委托引用
    int       SessionNo;                //会话编号
...
//338219 期权报价请求
struct CHundsunFutuReqFuncQuoteinsertField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338219 期权报价应答
struct CHundsunFutuRspFuncQuoteinsertField
{
    int       QuoteNo;                  //报价编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338220 报价撤单请求
struct CHundsunFutuReqFuncQuoteactionField
{
    int       QuoteNo;                  //报价编号
...
//338220 报价撤单应答
struct CHundsunFutuRspFuncQuoteactionField
{
    int       QuoteNo;                  //报价编号
    char      QuoteReference[32];       //报价委托引用
    int       SessionNo;                //会话编号
...
//338310 查询客户报价信息请求
struct CHundsunFutuReqFuncQuoteQryField
{
...
//338310 查询客户报价信息应答
struct CHundsunFutuRspFuncQuoteQryField
{
    char      PositionStr[100];         //定位串
    int       QuoteNo;                  //报价编号
    int       BranchNo;                 //分支机构
...
//338311 查询询价信息请求
struct CHundsunFutuReqFuncForquoteQryField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
    int       RequestNum;               //请求行数
...
//338311 查询询价信息应答
struct CHundsunFutuRspFuncForquoteQryField
{
    char      PositionStr[100];         //定位串
    int       BranchNo;                 //分支机构
    char      FundAccount[18];          //资产账户
...
//338312 查询期权交易成本请求
struct CHundsunFutuReqFuncOptioninstrtradecostQryField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
...
//338312 查询期权交易成本应答
struct CHundsunFutuRspFuncOptioninstrtradecostQryField
{
...
//338205 期权行权申请请求
struct CHundsunFutuReqFuncExecorderinsertField
{
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
    char      ApplyFlag;                //申请标志
...
//338205 期权行权申请应答
struct CHundsunFutuRspFuncExecorderinsertField
{
    int       ExerciseNo;               //行权编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338206 期权行权撤销申请请求
struct CHundsunFutuReqFuncExecorderactionField
{
    int       ExerciseNo;               //行权编号
    char      EntrustOccasion[32];      //委托场景
    char      EntrustReference[32];     //委托引用
...
//338206 期权行权撤销申请应答
struct CHundsunFutuRspFuncExecorderactionField
{
    int       ExerciseNo;               //行权编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338309 到期执行持仓查询请求
struct CHundsunFutuReqFuncExpireinvestorpositionQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338309 到期执行持仓查询应答
struct CHundsunFutuRspFuncExpireinvestorpositionQryField
{
    char      FundAccount[18];          //资产账户
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
...
//330853 组合代码查询请求
struct CHundsunFutuReqFuncArginstrumentQryField
{
    char      FutuExchType[4];          //交易类别
};

//330853 组合代码查询应答
struct CHundsunFutuRspFuncArginstrumentQryField
{
...
//330854 组合行情查询请求
struct CHundsunFutuReqFuncArgquoteQryField
{
    char      FutuExchType[4];          //交易类别
    char      ArbitCode[30];            //套利合约号
};
...
//330854 组合行情查询应答
struct CHundsunFutuRspFuncArgquoteQryField
{
    char      ArbitCode[30];            //套利合约号
    char      FutuExchType[4];          //交易类别
...
//338204 组合委托确认请求
struct CHundsunFutuReqFuncArgorderinsertField
{
    char      FuturesAccount[12];       //交易编码
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
...
//338204 组合委托确认应答
struct CHundsunFutuRspFuncArgorderinsertField
{
    int       EntrustNo;                //委托编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338224 期货中金套利组合确认请求
struct CHundsunFutuReqFuncFutuCombmarginactionInsertField
{
    char      FuturesAccount[12];       //交易编码
    char      FutuExchType[4];          //交易类别
    char      EntrustBs;                //买卖方向
...
//338224 期货中金套利组合确认应答
struct CHundsunFutuRspFuncFutuCombmarginactionInsertField
{
    int       EntrustNo;                //委托编号
    char      EntrustStatus;            //委托状态
    char      EntrustReference[32];     //委托引用
...
struct CHundsunFutuReqFuncInstrumentcommissionrateQryField
{
...
struct CHundsunFutuRspFuncInstrumentcommissionrateQryField
{
    char      FutufareType;             //费用类别
    char      FutucodeType[4];          //合约代码类别
    char      FutuCode[30];             //合约代码
...
//338305 UFT保证金属性查询请求
struct CHundsunFutuReqFuncInstrumentmarginrateQryField
{
    char      HedgeType;                //投机/套保类型
    char      FutucodeType[4];          //合约代码类别
    char      FutuCode[30];             //合约代码
...
//338305 UFT保证金属性查询应答
struct CHundsunFutuRspFuncInstrumentmarginrateQryField
{
    char      HedgeType;                //投机/套保类型
    char      FutucodeType[4];          //合约代码类别
    char      FutuCode[30];             //合约代码
...
//338313 交易所状态查询请求
struct CHundsunFutuReqFuncExchangestatusQryField
{
    char      FutuExchType[4];          //交易类别
};

//338313 交易所状态查询应答
struct CHundsunFutuRspFuncExchangestatusQryField
{
    char      FutuExchType[4];          //交易类别
...
//338314 交易所查询请求
struct CHundsunFutuReqFuncExchangeQryField
{
    char      FutuExchType[4];          //交易类别
};

//338314 交易所查询应答
struct CHundsunFutuRspFuncExchangeQryField
{
    char      FutuExchType[4];          //交易类别
...
//338323 期货中金组合持仓查询请求
struct CHundsunFutuReqFuncFutuComholeinfoQryField
{
    char      FutuExchType[4];          //交易类别
    char      EntrustBs;                //买卖方向
    char      QueryDirection;           //查询方向
...
//338323 期货中金组合持仓查询应答
struct CHundsunFutuRspFuncFutuComholeinfoQryField
{
    char      FutuExchType[4];          //交易类别
    char      PositionStr[100];         //定位串
    char      EntrustBs;                //买卖方向
...
//338324 期货中金组合委托查询请求
struct CHundsunFutuReqFuncFutuComentrustinfoQryField
{
    char      FutuExchType[4];          //交易类别
    char      EntrustBs;                //买卖方向
    char      FuturesDirection;         //开平仓方向
...
//338324 期货中金组合委托查询应答
struct CHundsunFutuRspFuncFutuComentrustinfoQryField
{
    int       InitDate;                 //交易日期
    int       EntrustNo;                //委托编号
    int       EntrustTime;              //委托时间
...
//330850 期货合约行情查询请求
struct CHundsunFutuReqFuncFutuContracthqQryField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
    int       RequestNum;               //请求行数
...
//330850 期货合约行情查询应答
struct CHundsunFutuRspFuncFutuContracthqQryField
{
    char      PositionStr[100];         //定位串
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
...
//330851 期货合约保证金查询请求
struct CHundsunFutuReqFuncFutuContractbailQryField
{
    char      UserToken[512];           //用户口令
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
...
//330851 期货合约保证金查询应答
struct CHundsunFutuRspFuncFutuContractbailQryField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
    char      FutuName[12];             //品种简称
...
//330852 取交易所时间差请求
struct CHundsunFutuReqFuncExchangetimeQryField
{
};

//330852 取交易所时间差应答
struct CHundsunFutuRspFuncExchangetimeQryField
{
    char      FutuExchType[4];          //交易类别
    int       CurrTime;                 //当前时间
    int       DiffTime;                 //时间差
...
//330855 监控中心查询密钥获取请求
struct CHundsunFutuReqFuncCfmmctradingaccountkeyQryField
{
};

//330855 监控中心查询密钥获取应答
struct CHundsunFutuRspFuncCfmmctradingaccountkeyQryField
{
...
//331124 密码校验请求
struct CHundsunFutuReqFundFutuChkpasswordField
{
};

//331124 密码校验应答
struct CHundsunFutuRspFundFutuChkpasswordField
{
    char      FundAccount[18];          //资产账户
    int       BranchNo;                 //分支机构
};
...
//331850 期货交易账号查询请求
struct CHundsunFutuReqFuncTradingcodeQryField
{
};

//331850 期货交易账号查询应答
struct CHundsunFutuRspFuncTradingcodeQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
...
//331851 期货客户账单确认请求
struct CHundsunFutuReqFuncSettlementInfoConfirmField
{
};

//331851 期货客户账单确认应答
struct CHundsunFutuRspFuncSettlementInfoConfirmField
{
    char      BillFlag;                 //确认标志
};

//332213 取期货登记银行信息请求
struct CHundsunFutuReqFundFutuBankinfoQryField
{
    char      MoneyType[3];             //币种类别
};

//332213 取期货登记银行信息应答
struct CHundsunFutuRspFundFutuBankinfoQryField
{
    char      BankNo[4];                //银行代码
    char      BankName[64];             //银行名称
    char      BankAccount[32];          //银行账号
...
//338200 检查期货合约代码请求
struct CHundsunFutuReqFuncFutuCheckFutuCodeField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
    char      FuturesAccount[12];       //交易编码
...
//338200 检查期货合约代码应答
struct CHundsunFutuRspFuncFutuCheckFutuCodeField
{
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
    char      FuturesAccount[12];       //交易编码
...
//338201 期货可买卖数量获取请求
struct CHundsunFutuReqFuncMaxordervolumeField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338201 期货可买卖数量获取应答
struct CHundsunFutuRspFuncMaxordervolumeField
{
    int       EnableAmount;             //可用数量
...
//338202 期货委托确认请求
struct CHundsunFutuReqFuncOrderinsertField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338202 期货委托确认应答
struct CHundsunFutuRspFuncOrderinsertField
{
    int       EntrustNo;                //委托编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338203 检查组合合约代码请求
struct CHundsunFutuReqFuncFutuCheckCombineFutuCodeField
{
    char      FuturesAccount[12];       //交易编码
    char      FutuExchType[4];          //交易类别
    char      FutuCode[30];             //合约代码
...
//338203 检查组合合约代码应答
struct CHundsunFutuRspFuncFutuCheckCombineFutuCodeField
{
    char      ArbitCode[30];            //套利合约号
    char      FutuExchType[4];          //交易类别
...
//338217 期货委托撤单请求
struct CHundsunFutuReqFuncOrderactionField
{
    char      FutuExchType[4];          //交易类别
    int       EntrustNo;                //委托编号
    char      ConfirmId[20];            //主场单号
...
//338217 期货委托撤单应答
struct CHundsunFutuRspFuncOrderactionField
{
    int       EntrustNo;                //委托编号
    char      EntrustReference[32];     //委托引用
    int       SessionNo;                //会话编号
...
//338300 期货客户资金查询请求
struct CHundsunFutuReqFuncTradingaccountQryField
{
    char      MoneyType[3];             //币种类别
};

//338300 期货客户资金查询应答
struct CHundsunFutuRspFuncTradingaccountQryField
{
    char      MoneyType[3];             //币种类别
    double    CurrentBalance;           //当前余额
    double    EnableBalance;            //可用资金
...
//338301 期货当日委托查询请求
struct CHundsunFutuReqFuncOrderQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338301 期货当日委托查询应答
struct CHundsunFutuRspFuncOrderQryField
{
    int       BatchNo;                  //委托批号
    int       EntrustNo;                //委托编号
    char      FundAccount[18];          //资产账户
...
//338302 期货当日成交查询请求
struct CHundsunFutuReqFuncTradeQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338302 期货当日成交查询应答
struct CHundsunFutuRspFuncTradeQryField
{
    int       EntrustNo;                //委托编号
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
...
//338303 期货持仓查询请求
struct CHundsunFutuReqFuncInvestorpositionQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338303 期货持仓查询应答
struct CHundsunFutuRspFuncInvestorpositionQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338306 当日资金流水查询请求
struct CHundsunFutuReqFuncFutuFundjourQryField
{
    char      MoneyType[3];             //币种类别
    int       RequestNum;               //请求行数
    char      PositionStr[100];         //定位串
...
//338306 当日资金流水查询应答
struct CHundsunFutuRspFuncFutuFundjourQryField
{
...
//338307 持仓明细查询请求
struct CHundsunFutuReqFuncInvestorpositiondetailQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//338307 持仓明细查询应答
struct CHundsunFutuRspFuncInvestorpositiondetailQryField
{
    int       OpenDate;                 //开户日期
    int       SerialNo;                 //流水序号
    int       BranchNo;                 //分支机构
...
//338308 取系统信息请求
struct CHundsunFutuReqFuncFutuSysinfoQryField
{
    int       OpBranchNo;               //操作分支机构
    char      OpEntrustWay;             //委托方式
    char      OpStation[255];           //站点地址
...
//338308 取系统信息应答
struct CHundsunFutuRspFuncFutuSysinfoQryField
{
    char      CurrDatetime[14];         //当前日期时间
};

//339851 取客户账单请求
struct CHundsunFutuReqFuncSettlementinfoQryField
{
    int       BeginDate;                //起始日期
    int       EndDate;                  //到期日期
    char      MoneyType[3];             //币种类别
...
//339851 取客户账单应答
struct CHundsunFutuRspFuncSettlementinfoQryField
{
...
//339852 期货历史委托查询请求
struct CHundsunFutuReqFuncHisorderQryField
{
    char      FutuExchType[4];          //交易类别
    char      FuturesAccount[12];       //交易编码
    char      FutuCode[30];             //合约代码
...
//339852 期货历史委托查询应答
struct CHundsunFutuRspFuncHisorderQryField
{
    int       InitDate;                 //交易日期
    int       EntrustNo;                //委托编号
    char      FundAccount[18];          //资产账户
...
//339853 期货历史成交查询请求
struct CHundsunFutuReqFuncHistradeQryField
{
    int       BeginDate;                //起始日期
    int       EndDate;                  //到期日期
    char      FutuExchType[4];          //交易类别
...
//339853 期货历史成交查询应答
struct CHundsunFutuRspFuncHistradeQryField
{
    int       InitDate;                 //交易日期
    int       SerialNo;                 //流水序号
    char      FutuExchType[4];          //交易类别
...
//339854 取客户历史资金请求
struct CHundsunFutuReqFuncHistradingaccountQryField
{
    int       QueryDate;                //查询日期
    char      MoneyType[3];             //币种类别
};
...
//339854 取客户历史资金应答
struct CHundsunFutuRspFuncHistradingaccountQryField
{
    char      FundAccount[18];          //资产账户
    char      ClientId[18];             //客户编号
    char      ClientName[14];           //客户姓名
...
//338000 期权代码信息查询请求
struct CHundsunFutuReqFuncOptOptcodeQryField
{
...
//338000 期权代码信息查询应答
struct CHundsunFutuRspFuncOptOptcodeQryField
{
...
//338001 期权标的信息查询请求
struct CHundsunFutuReqFuncOptOptobjectcodeQryField
{
    char      ExchangeType[4];          //交易类别
    char      StockCode[16];            //证券代码
    char      PositionStr[100];         //定位串
...
//338001 期权标的信息查询应答
struct CHundsunFutuRspFuncOptOptobjectcodeQryField
{
    char      ExchangeType[4];          //交易类别
    char      StockCode[16];            //证券代码
    char      StockType[4];             //证券类别
...
//338002 期权代码输入确认请求
struct CHundsunFutuReqFuncOptOptcodeEnterField
{
    char      ExchangeType[4];          //交易类别
    char      OptionCode[9];            //期权合约编码
};
...
//338002 期权代码输入确认应答
struct CHundsunFutuRspFuncOptOptcodeEnterField
{
    char      NoticeInfo[255];          //提示信息
};

//338010 期权可交易数量获取请求
struct CHundsunFutuReqFuncOptEnTradeField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
...
//338010 期权可交易数量获取应答
struct CHundsunFutuRspFuncOptEnTradeField
{
    int       EnableAmount;             //可用数量
};

//338011 期权委托请求
struct CHundsunFutuReqFuncOptEntrustField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338011 期权委托应答
struct CHundsunFutuRspFuncOptEntrustField
{
    int       InitDate;                 //交易日期
    int       EntrustNo;                //委托编号
    int       ReportNo;                 //申请编号
...
//338012 期权撤单请求
struct CHundsunFutuReqFuncOptWithdrawField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
    int       EntrustNo;                //委托编号
...
//338012 期权撤单应答
struct CHundsunFutuRspFuncOptWithdrawField
{
    int       InitDate;                 //交易日期
    int       EntrustNo;                //委托编号
...
//338020 期权委托查询请求
struct CHundsunFutuReqFuncOptEntrustQryField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338020 期权委托查询应答
struct CHundsunFutuRspFuncOptEntrustQryField
{
    int       InitDate;                 //交易日期
    int       BatchNo;                  //委托批号
    int       EntrustNo;                //委托编号
...
//338021 期权成交查询请求
struct CHundsunFutuReqFuncOptRealtimeQryField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338021 期权成交查询应答
struct CHundsunFutuRspFuncOptRealtimeQryField
{
    int       InitDate;                 //交易日期
    int       SerialNo;                 //流水序号
    char      ExchangeType[4];          //交易类别
...
//338022 期权资产查询请求
struct CHundsunFutuReqFuncOptAssetQryField
{
    char      AssetProp;                //资产属性
    char      MoneyType[3];             //币种类别
};
...
//338022 期权资产查询应答
struct CHundsunFutuRspFuncOptAssetQryField
{
...
//338023 期权持仓查询请求
struct CHundsunFutuReqFuncOptHoldQryField
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338023 期权持仓查询应答
struct CHundsunFutuRspFuncOptHoldQryField
{
    char      FundAccount[18];          //资产账户
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338024 期权行权指派查询请求
struct CHundsunFutuReqFuncOptExeassignQryField
{
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
    char      OptholdType;              //期权持仓类别
...
//338024 期权行权指派查询应答
struct CHundsunFutuRspFuncOptExeassignQryField
{
    char      FundAccount[18];          //资产账户
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//338025 期权行权交割信息查询请求
struct CHundsunFutuReqFuncAssetOptexedeliverQryField
{
    char      ExchangeType[4];          //交易类别
    char      StockCode[16];            //证券代码
    char      PositionStr[100];         //定位串
...
//338025 期权行权交割信息查询应答
struct CHundsunFutuRspFuncAssetOptexedeliverQryField
{
    int       InitDate;                 //交易日期
    int       BranchNo;                 //分支机构
    char      ExchangeType[4];          //交易类别
...
struct CHundsunFutuReqFuncAssetDebtinfoQryField
{
    char      StockCode[16];            //证券代码
...
struct CHundsunFutuRspFuncAssetDebtinfoQryField
{
    int       InitDate;                 //交易日期
    int       BranchNo;                 //分支机构
    char      ExchangeType[4];          //交易类别
...
//338027 期权标的证券数量提示请求
struct CHundsunFutuReqFuncOptUnderlyamountPromptField
{
    char      OptionCode[9];            //期权合约编码
    int       EntrustAmount;            //委托数量
    char      EntrustBs;                //买卖方向
...
//338027 期权标的证券数量提示应答
struct CHundsunFutuRspFuncOptUnderlyamountPromptField
{
    char      NoticeInfo[255];          //提示信息
};

//338028 客户期权持仓合约信息提示请求
struct CHundsunFutuReqFuncOptOptholdrealPromptField
{
    char      AssetProp;                //资产属性
    char      MoneyType[3];             //币种类别
};
...
struct CHundsunFutuRspFuncOptOptholdrealPromptField
{
    char      OptionCode[9];            //期权合约编码
    char      OptionName[32];           //期权合约简称
    char      NoticeInfo[255];          //提示信息
...
//338029 客户备兑证券不足查询请求
struct CHundsunFutuReqFuncAssetAssetcoverstockQryField
{
    char      StockCode[16];            //证券代码
    char      PositionStr[100];         //定位串
    int       RequestNum;               //请求行数
...
//338029 客户备兑证券不足查询应答
struct CHundsunFutuRspFuncAssetAssetcoverstockQryField
{
    int       BranchNo;                 //分支机构
    char      ExchangeType[4];          //交易类别
    char      ClientId[18];             //客户编号
...
struct CHundsunFutuReqFuncOptCoveredQryField
{
    char      FundAccountOpt[18];       //期权资产账户
    char      OptionAccount[13];        //衍生品合约账户
...
struct CHundsunFutuRspFuncOptCoveredQryField
{
    char      ExchangeType[4];          //交易类别
    char      StockCode[16];            //证券代码
    char      StockName[32];            //证券名称
...
//338031 备兑证券划转请求
struct CHundsunFutuReqFuncOptCoveredTransField
{
    char      FundAccountOpt[18];       //期权资产账户
    char      OptionAccount[13];        //衍生品合约账户
    char      StockAccount[11];         //证券账号
...
//338031 备兑证券划转应答
struct CHundsunFutuRspFuncOptCoveredTransField
{
    int       InitDate;                 //交易日期
    int       EntrustNo;                //委托编号
    int       EntrustTime;              //委托时间
...
//339800 历史期权委托查询请求
struct CHundsunFutuReqFuncHisOptentrustQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
    char      ExchangeType[4];          //交易类别
...
//339800 历史期权委托查询应答
struct CHundsunFutuRspFuncHisOptentrustQryField
{
    int       EntrustNo;                //委托编号
    char      ExchangeType[4];          //交易类别
    char      OptionAccount[13];        //衍生品合约账户
...
//339801 历史期权成交查询请求
struct CHundsunFutuReqFuncHisOptbusinessQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
    char      ExchangeType[4];          //交易类别
...
//339801 历史期权成交查询应答
struct CHundsunFutuRspFuncHisOptbusinessQryField
{
    int       InitDate;                 //交易日期
    int       SerialNo;                 //流水序号
    char      ExchangeType[4];          //交易类别
...
//339803 历史期权交割信息查询请求
struct CHundsunFutuReqFuncHisOptdeliverQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
...
//339803 历史期权交割信息查询应答
struct CHundsunFutuRspFuncHisOptdeliverQryField
{
    int       InitDate;                 //交易日期
    int       EntrustDate;              //委托日期
...
//339804 历史期权行权指派查询请求
struct CHundsunFutuReqFuncHisExeassignQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
    char      ExchangeType[4];          //交易类别
...
//339804 历史期权行权指派查询应答
struct CHundsunFutuRspFuncHisExeassignQryField
{
    int       InitDate;                 //交易日期
    char      FundAccount[18];          //资产账户
    char      ExchangeType[4];          //交易类别
...
struct CHundsunFutuReqFuncHisOptexedeliverQryField
{
    int       StartDate;                //开始日期
    int       EndDate;                  //到期日期
    char      StockCode[16];            //证券代码
...
struct CHundsunFutuRspFuncHisOptexedeliverQryField
{
    int       InitDate;                 //交易日期
    int       BranchNo;                 //分支机构
    char      ExchangeType[4];          //交易类别
...
//339806 历史期权对账单查询请求
struct CHundsunFutuReqFuncHisOptstatementQryField
{
    int       BeginDate;                //起始日期
    int       EndDate;                  //到期日期
    char      FundAccount[18];          //资产账户
...
//339806 历史期权对账单查询应答
struct CHundsunFutuRspFuncHisOptstatementQryField
{
    int       InitDate;                 //交易日期
    int       BusinessFlag;             //业务标志
    char      BusinessType;             //业务类型
...
//339807 取客户账单请求
struct CHundsunFutuReqFuncOptSettlementinfoQryField
{
    int       BeginDate;                //起始日期
    int       EndDate;                  //到期日期
    char      MoneyType[3];             //币种类别
...
//339807 取客户账单应答
struct CHundsunFutuRspFuncOptSettlementinfoQryField
{
    char      CheckTabData[2000];       //帐单信息
};

//395 期权行情查询请求
struct CHundsunFutuReqFuncOptPriceQryField
{
    char      ExchangeType[4];          //交易类别
    char      OptionCode[9];            //期权合约编码
};
...
//395 期权行情查询应答
struct CHundsunFutuRspFuncOptPriceQryField
{
    double    OptLastPrice;             //最新价
...
//33100 主推-期货单腿行情主推
struct CHundsunFutuRtnFuncQhSingleHqPushField
{
...
//33101 委托回报主推
struct CHundsunFutuRtnFuncQhEntrustPushField
{
    int       EntrustNo;                //委托号
    char      FuturesAccount[12];       //交易编码
...
//33101 成交回报主推
struct CHundsunFutuRtnFuncQhRealPushField
{
    int       EntrustNo;                //委托号
    char      FuturesAccount[12];       //交易编码
...
//33102 主推-期货组合行情主推
struct CHundsunFutuRtnFuncQhCombinePushField
{
    char      ArbitCode[30];            //套利合约号
    char      FutuExchType[4];          //交易类别
...
struct CHundsunFutuRtnFuncQhExchStatusPushField
{
...
//33300 主推-期货询价通知主推
struct CHundsunFutuRtnFuncQhInquiryPushField
{
    int       InquiryNo;                //询价编号
    char      FutuCode[30];             //合约代码
    int       InitDate;                 //交易日期
...
//33301 主推-期货报价回报主推
struct CHundsunFutuRtnFuncQhQuotePushField
{
    char      FutuExchType[3];          //交易所类别（F1-郑州F2大连-F3上海-F4中金）
    char      FutuCode[30];             //合约代码
...
//33011 主推-个股期权成交回报主推
struct CHundsunFutuRtnFuncOptDealPushField
{
    int       InitDate;                 //交易日期
    int       BranchNo;                 //分支机构
    char      ClientId[18];             //客户编号
...
//33012 主推-个股期权委托回写主推
struct CHundsunFutuRtnFuncOptEntrustPushField
{
    int       BranchNo;                 //分支机构
    char      FundAccount[18];          //资产账户
    int       ReportNo;                 //申请编号

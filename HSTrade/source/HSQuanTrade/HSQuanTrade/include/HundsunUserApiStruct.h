...
{
    char      AssetProp;                //资产属性
    char      ExchangeType[4];          //交易类别      2
    char      OptionAccount[13];        //衍生品合约账户
    char      OptionCode[9];            //期权合约编码  20003928
    int       EntrustAmount;            //委托数量      1
    double    OptEntrustPrice;          //委托价格      16
    char      EntrustBs;                //买卖方向      1
    char      EntrustOc;                //开平仓方向    1
    char      CoveredFlag;              //备兑标志
    char      EntrustProp[3];           //委托属性       0
    int       BatchNo;                  //委托批号
};

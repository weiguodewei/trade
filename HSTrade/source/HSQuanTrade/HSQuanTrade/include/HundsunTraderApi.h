...
public:
    ...
    virtual void OnRspFuncOptDealSubscribe(CHundsunRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

    //620002_33011 订阅取消-个股期权成交应答
    virtual void OnRspFuncOptDealCancel(CHundsunRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

    //620003_33011 主推-个股期权成交回报应答
    virtual void OnRtnFuncOptDealPush(CHundsunRtnFuncOptDealPushField *pFuncOptDealPush) {};
                 
    //620001_33012 订阅-个股期权委托回写应答
    virtual void OnRspFuncOptEntrustSubscribe(CHundsunRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

    //620002_33012 订阅取消-个股期权委托回写应答
    virtual void OnRspFuncOptEntrustCancel(CHundsunRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};

    //620003_33012 主推-个股期权委托回写应答
    virtual void OnRtnFuncOptEntrustPush(CHundsunRtnFuncOptEntrustPushField *pFuncOptEntrustPush) {};
...
public:
    ...
    ///620001_33011 订阅-个股期权成交回写请求
    virtual int ReqFuncOptDealSubscribe(int nRequestID = 0) = 0;

    ///620002_33011 订阅取消-个股期权成交请求
    virtual int ReqFuncOptDealCancel(int nRequestID = 0) = 0;

    ///620001_33012 订阅-个股期权委托回写请求
    virtual int ReqFuncOptEntrustSubscribe(int nRequestID = 0) = 0;

    ///620002_33012 订阅取消-个股期权委托回写请求
    virtual int ReqFuncOptEntrustCancel(int nRequestID = 0) = 0;
